...
class TwoViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,UIAlertViewDelegate {
...
//        headView.frame = CGRect(x: 0,y: 0,width: KWidth,height: 200)
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "notiAction", name: "OneSwift", object: nil)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = "huangxiaoming  -- >\(indexPath.row)"
    ...
    func scrollViewDidEndDecelerating(scrollView: UIScrollView) {
        ...
        dic["inforY"] = offer
        NSNotificationCenter.defaultCenter().postNotificationName("tutorSwift", object: nil, userInfo: dic);
